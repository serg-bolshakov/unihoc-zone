        ...
        <div class = "cardProduct-line__block">
            ...
            <div class="cardProduct-props">
                <div class="cardProduct-props__item">
                    ...
                    <div class="cardProduct-props__item-hook-left">Левый</div>
                    <div class="cardProduct-props__item-hook-right">Правый</div>
                </div>
        ...
        <div class = "cardProduct-descDetails__block">
            ...
            <div class = "cardProduct-details">
                ...
                <?php if ($item->weight): ?>
                    ...
                    <div class = "cardStick-detail__value"><?= $item->weight?></div>
                <?php endif; ?>
                
                <?php if ($item->material): ?>
                    <div class = "cardProduct-detail__name">Материал:</div>
                    <div class = "cardStick-detail__value"><?= $item->material?></div>
                <?php endif; ?>
                
                <?php if ($propFlex): ?>
                    <div class="cardProduct-detail__name pop-up__cardProduct-hint">Степень жёсткости:
                        <div class="pop-up__cardProduct-hint-text">
                        <?=include $_SERVER['DOCUMENT_ROOT'] . "/elems/articles/blade-stiffness.php";?>
                        </div>
                    </div>
                    <div class = "cardStick-detail__value"><?= $propFlex->prop_value_view?></div>
                <?php endif; ?>
                ...
                <?php if ($item->iff): ?>
                    ...
                    <div class = "cardStick-detail__value"><?= $item->iff?></div>
                <?php endif; ?>
